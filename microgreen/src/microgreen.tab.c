...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_POTENCIA = 3,                 /* T_POTENCIA  */
  YYSYMBOL_T_ESPERAR = 4,                  /* T_ESPERAR  */
  YYSYMBOL_T_AQUECER = 5,                  /* T_AQUECER  */
  YYSYMBOL_T_ATE = 6,                      /* T_ATE  */
  YYSYMBOL_T_MANTER = 7,                   /* T_MANTER  */
  YYSYMBOL_T_ACIMA = 8,                    /* T_ACIMA  */
  YYSYMBOL_T_DE = 9,                       /* T_DE  */
  YYSYMBOL_T_POR = 10,                     /* T_POR  */
  YYSYMBOL_T_ALARME = 11,                  /* T_ALARME  */
  YYSYMBOL_T_SE = 12,                      /* T_SE  */
  YYSYMBOL_T_TEMPERATURA = 13,             /* T_TEMPERATURA  */
  YYSYMBOL_T_MAIOR = 14,                   /* T_MAIOR  */
  YYSYMBOL_T_MENOR = 15,                   /* T_MENOR  */
  YYSYMBOL_T_IGUAL = 16,                   /* T_IGUAL  */
  YYSYMBOL_T_MOSTRAR = 17,                 /* T_MOSTRAR  */
  YYSYMBOL_T_BIPE = 18,                    /* T_BIPE  */
  YYSYMBOL_T_PARAR = 19,                   /* T_PARAR  */
  YYSYMBOL_T_HALT = 20,                    /* T_HALT  */
  YYSYMBOL_T_SEMI = 21,                    /* T_SEMI  */
  YYSYMBOL_T_NL = 22,                      /* T_NL  */
  YYSYMBOL_T_ERROR = 23,                   /* T_ERROR  */
  YYSYMBOL_T_INT = 24,                     /* T_INT  */
  YYSYMBOL_T_DUR = 25,                     /* T_DUR  */
  YYSYMBOL_YYACCEPT = 26,                  /* $accept  */
  YYSYMBOL_programa = 27,                  /* programa  */
  YYSYMBOL_linhas = 28,                    /* linhas  */
  YYSYMBOL_linha = 29,                     /* linha  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "T_POTENCIA",
  "T_ESPERAR", "T_AQUECER", "T_ATE", "T_MANTER", "T_ACIMA", "T_DE",
...
{
       0,     1,     3,     3,     4,     5,     0,     7,    14,    15,
      16,    11,    13,    21,    22,    24,     6,    17,    18,    19,
      20,    25,     8,    12,     9,    24,    13,    24,    10,    24,
      -1,    -1,    25
};
